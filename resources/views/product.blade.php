                    ...
                    <div class="row">
                                ...
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="blur-up lazyload zoompro"
                                            ...
                                            alt="" src="assets/images/collection/paint6.jpg" />
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                <h1 class="product-single__title">Painting 1 <br><h6> By: Atul Pratap Singh</h6></h1>
                                ...
                                <div class="prInfoRow">
                                    ...
                                    <div class="product-sku">Product Id: <span class="variant-sku">19115-rdxs</span></div>
                                ...
                                <p class="product-single__price product-single__price-product-template">
                                    ...
                                    <s id="ComparePrice-product-template" style="text-decoration: none;"><span class="money">Bid Amount: </span></s>
                                    <span
                                ...
                                <form method="post" action="http://annimexweb.com/cart/add"
                                    ...
                                    <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                        <div class="product-form__item">
                                            <label class="header">Painting Dimension: <span class="slVariant">18" h x 36" w x .25" d
                                                |
