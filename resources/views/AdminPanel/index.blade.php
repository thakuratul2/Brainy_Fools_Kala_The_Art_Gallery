...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{route('admin.dash')}}" class="logo d-flex align-items-center">
        <img src="{{asset('assets/images/favicon.ico')}}" alt="">
        <span class="d-none d-lg-block">Kala | Admin Panel</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{route('logout.option')}}">
